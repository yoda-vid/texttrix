...
// 			"" + getCaretPosition(),
	...
	*/
	 ...
	 * contains this Text Pad so that the caret is toward the top of the 
	 * pad's viewable area.
	 * 
	...
	public void setCaretPositionTop(int position) {
		...
		try {
			...
			// to 1/3 down the viewport, and setViewPosition is
			...
			if (rect != null) {
				int recty = rect.y - viewportRect.height / 3;
				if (recty < 0) recty = 0;
